...
ALN_tpCondRet ALU_CriaAluno(Aluno **a, char *nome, unsigned int mat, unsigned long cpf, unsigned int telefone, Data *nasc, Endereco* end);
...
ALN_tpCondRet ALU_AlteraDados(Aluno *a, char *nome, unsigned int mat, unsigned long cpf, unsigned int telefone, Data *nasc, Endereco* end);
...
ALN_tpCondRet ALU_SolicitaDados(char *nome, unsigned int *mat, unsigned long *cpf, unsigned int *telefone, Data *nasc, Endereco* end);

// Função que copia os dados do aluno
ALN_tpCondRet ALU_GetAll(Aluno *a, char *nome, unsigned int *mat, unsigned long *cpf, unsigned int *tel, Data *nasc, Endereco *endereco);
